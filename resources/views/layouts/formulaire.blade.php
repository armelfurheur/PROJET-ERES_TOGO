        ...
        <div class="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-xs text-green-600 font-semibold tracking-wider uppercase">
                        ERES-TOGO - Rapport de remontée d'Anomalie
                    </div>
                </div>
            </div>
        </div>
...
document.getElementById('anomalie-form').addEventListener('submit', function(e) {
    ...
    .then(text => {
        try {
            ...
            toastr.error('La soumission a échoué. Vérifie que tu es connecté ou que la session a expiré.', 'Erreur');
        }
    })
    .catch(error => {
